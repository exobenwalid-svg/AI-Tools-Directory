        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {curations.map((comparison) => (
              <Link
                key={generateComparisonSlug(comparison.slugA, comparison.slugB)}
                href={`/compare/${generateComparisonSlug(comparison.slugA, comparison.slugB)}`}
